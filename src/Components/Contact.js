                    ...
                    <div className="col-lg-8">
                        <div className="contact-card">
                            <form onSubmit={onSubmit}>
                                ...
                                {loading ? <i class="fa-solid fa-spinner fa-spin-pulse fs-5 mt-4 ms-4"></i> : <button disabled={loading} type="submit" className="btn btn-theme download-btn mt-4">Send Me Message<i className="fa-solid fa-envelope ms-1"></i></button>}
