    ...
    return (
        <React.Fragment>
            ...
            <div className="section-gap skill-gap" id="skills">
                ...
                <p className="sub-title scroll-animate">Pro Skills</p>
                <h1 className="text-center title scroll-animate">Explore My Skills</h1>

                <div className="row align-items-stretch justify-content-center">
                    <div className="col-lg-3 col-sm-6 my-3">

                        <div className="skill-cards scroll-animate">
