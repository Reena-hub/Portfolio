            ...
            <div className="row my-4 align-items-stretch" id="about">
                <div className="col-xl-4 col-lg-5 mb-lg-0 mb-4">
                    <div className="about-card text-center h-100">
                        <div className="d-flex justify-content-center">
                            ...
                            <h2 className="mt-2 scroll-animate">Reena G</h2>
                            <div className="proifle-data scroll-animate">I'm a Full Stack Developer from Chennai</div>
                            <div className="d-flex mt-3 justify-content-around gap-2 align-items-center flex-wrap scroll-animate">
                ...
                <div className="col-xl-8 col-lg-7">
                    <div className="about-card mb-4">
                        <p className="hello scroll-animate">Hello There!</p>
                        <h1 className="my-3 scroll-animate">I'm Reena, a MERN Stack Web Developer.</h1>
                        <p className="mb-3 about-p scroll-animate">I am a MERN Stack Developer with a strong track record of designing and delivering scalable, high-performance web applications. Skilled in MongoDB, Express.js, React, and Node.js, I craft clean, efficient, and maintainable code while ensuring seamless user experiences.</p>
                        <a href="/resume.pdf" className="scroll-animate" download="Reena_Resume.pdf">
